        ...
        if connection_request_id:
            ...
            if connection_request.receiver == user:
                if connection_request: 
                    ...
                    textToStudent = f'Your connection request as been accepted by {user.tutorprofile.fullname} all the best for your {user.tutorprofile.subject_name} learning, visit the link https://beapro.tech/tutorprofiles/{user.id} you get one free Demo class:) from {user.tutorprofile.fullname}'
                    textToTutor = f'Congrats for getting your new student {connection_request.sender.studentprofile.fullname} you can click the link to visit their profile https://beapro.tech/student/studentview/{connection_request.sender.id}, [Tutor must give one free Demo class] '
